...
export default function Index({ auth, contacts }) {
    ...
    return (
        ...
        >
            ...
            <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 m-auto max-w-5xl">
                ...
                <div className="overflow-x-auto rounded-md">
                    <table className="min-w-full divide-y divide-gray-200">
                        <thead className="bg-gray-50">
                            <tr>
                                <th scope="col" className="px-3 py-2 sm:px-4 sm:py-3 text-left text-xs lg:text-sm font-medium text-gray-500 uppercase tracking-wider">Type</th>
                                <th scope="col" className="hidden sm:table-cell px-4 py-2 text-left text-xs lg:text-sm font-medium text-gray-500 uppercase tracking-wider">Detail</th>
                            ...
                            {contacts.map((contact) => (
                                <React.Fragment key={contact.id}>
                                    <tr className={expandedRows.includes(contact.id) ? 'bg-gray-50' : ''}>
                                        <td className="px-3 py-2 sm:px-4 sm:py-3 whitespace-nowrap text-xs sm:text-sm font-medium text-gray-900 capitalize">
                                        ...
                                        <td className="hidden sm:table-cell px-4 py-2 whitespace-nowrap text-xs sm:text-sm text-gray-500 max-w-xs truncate">{contact.detail}</td>
                                    ...
                                    {expandedRows.includes(contact.id) && (
                                        <tr className="bg-gray-50 sm:hidden">
                                            <td colSpan="3" className="px-3 py-3 sm:px-6 sm:py-4">
                                                <div className="grid grid-cols-1 gap-4">
                                                    ...
                                                    <div>
                                                        ...
                                                        <span className="text-sm text-gray-500 break-all">{contact.detail}</span>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
