...
export default function Create({ auth, genres }) {
    ...
    const deleteGenre = (e, id) => {
        e.stopPropagation();
        if (confirm('Are you sure you want to delete this genre? This cannot be undone.')) {
    ...
    return (
        <AdminLayout user={auth.user} header="Create New Book">
            <Head title="Add Book" />
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                            <div className="p-6 border-b border-gray-100 bg-gray-50/50">
                                ...
                                <p className="text-sm text-gray-500">Provide the title, synopsis and detailed metadata.</p>
                            </div>
                    ...
                    <div className="space-y-6">
                            ...
                            <div className="flex flex-wrap gap-2 max-h-60 overflow-y-auto p-1">
                                {genres.map((genre) => (
                                    <div
                                        ...
                                        className={`
                                            group inline-flex items-center px-3 py-1.5 rounded-full text-sm font-medium transition-all duration-200 border cursor-pointer select-none
                        ...
                        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                            ...
                            <div className="flex gap-2 mb-4">
                                <input
                                    type="number"
                                    className="flex-1 w-full border-gray-300 rounded-lg shadow-sm focus:border-indigo-500 focus:ring-indigo-500 p-2 text-sm"
                                    ...
                                    onKeyDown={(e) => {
                                        if (e.key === 'Enter') {
                                            ...
                                            if (val && !data.duplicate_book_ids.includes(val)) {
                                                setData('duplicate_book_ids', [...data.duplicate_book_ids, val]);
                                                e.target.value = '';
                                            }
                                        }
                                    }}
                            ...
                            <div className="flex flex-wrap gap-2">
                                {data.duplicate_book_ids.map((id) => (
                                    ...
                                    >
                                        <span className="truncate max-w-[150px]">Book ID: {id}</span>
                                        <button
                                            type="button"
                        ...
                        {/* Action Buttons (Sticky or just at bottom of sidebar) */}
