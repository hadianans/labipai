                        ...
                        <div className="md:col-span-2 space-y-6">
                            ...
                            <div>
                                ...
                                <TextInput
                                    id="title"
                                    type="text"
                                    className="mt-1 p-2 block w-full text-lg font-bold"
                                    value={data.title}
                            ...
                            <div>
                                ...
                                <div className="mt-1 h-96 pb-12"> {/* Height container including toolbar space */}
                                    <ReactQuill
                                        ref={quillRef}
                                        theme="snow"
                                        value={data.content}
                            ...
                            <div className="mt-8"> {/* Added margin top to clear editor */}
                                <InputLabel htmlFor="excerpt" value="Excerpt" />
                                <textarea
                                    id="excerpt"
                                    className="mt-1 block p-2 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm"
                                    rows="3"
                                    value={data.excerpt}
